...
%%
% Files
v_filenameRef = 'TDS_ReferenceSandwich_143.5-169-0.05ps_6avg_100ms-50mV20210721.dat'; % Insert file name for reference
v_filenameSam = 'TDS_Pr'; % Insert file name for sample
